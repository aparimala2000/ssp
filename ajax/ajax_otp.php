...
switch ($req_action) {
    case "ajax_regg";
        ...
        if (($usrVerf_email == false || $usrVerf_phone == false) && ($usrVerf_email != Yes && $usrVerf_phone != Yes)) {
            ...
            if ($notVerAcc != false && !current_user_can('administrator')) {
            ...
            } elseif ($phoneChk != false && !current_user_can('administrator')) {
            ...
            if (phone_exists($username)) {
                ...
                foreach ($users_phone_args as $key => $users_phone) {
                    ...
                    if ($usrVerf == 'Yes') {
                        ...
                        echo '1|' . $userPhoneId;
                    } elseif ($usrVerf == 'No' && !current_user_can('administrator')) {
                        // wp_delete_user($notVerAcc);
