...
/**********
Template Name: Shop Industrial use

 **********/
get_header('shop'); ?>
<!-- banner section start -->
<?php if ($post = get_page_by_path('industrial-use', OBJECT, 'page')) { ?>
...
$category_slug = 'industrial-use'; // replace with the slug of the category you want to retrieve 
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <h5 class="mb-30 mt-4 mt-lg-0">For Hotel</h5>
