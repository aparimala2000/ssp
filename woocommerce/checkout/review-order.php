...
<div>
								...
								<div class="flex-grow-1">
									<div class="d-flex justify-content-between">
										...
										?>
											...
											?>
												<span class="md mb-1" id="checkout_price<?php echo $var_id; ?>"><?php echo  wc_price($var_reg_prc * $qtyy); ?></span>
						...
						<!-- <div class="cart-row">
							...
							<div class="d-flex justify-content-between align-items-center">
								...
								if (!empty($cart_item['variation_id'])) {
									...
									if ($var_sal_prc != '') {
								?>
										<span class="md" id="checkout_price<?php echo $var_id; ?>"><?php echo wc_price($var_reg_prc * $qtyy); ?></span>
									...
									if ($sale_price != '') {
									?>
										<span class="md" id="checkout_price<?php echo $simpleid; ?>"><?php echo $regular_price * $qtyy; ?></span>
										<span class="md" style="display: none">&#x20B9;<?php echo $sale_price; ?></span>
										<input type="hidden" name="check-prc" class="check-prc" value="<?php echo $sale_price; ?>">
										<input type="hidden" name="unit-prc" class="unit-prc" value="<?php echo $regular_price; ?>">
									<?php } else { ?>
										<span class="md" id="checkout_price<?php echo $simpleid; ?>"><?php echo wc_price($regular_price * $qtyy); ?></span>
										<span class="md" style="display: none"></span>
										<input type="hidden" name="check-prc" class="check-prc" value="<?php echo $regular_price; ?>">
	...
	function is_customer_last_3_orders_within_3_months()
	{
	...
	// Display the result
	$is_qualifying_customer = is_customer_last_3_orders_within_3_months();
	...
	// 			$interval = $current_date->diff($last_order_date);
	// 			$months_difference = $interval->y * 12 + $interval->m;
	// 			// var_dump($interval);
	// 			//echo $months_difference;
	// 			if ($months_difference <= 3) {
	// 				return true;
	// 				// echo 'Customer Name: ' . get_user_meta($user_id, 'billing_first_name', true) . ' ' . get_user_meta($user_id, 'billing_last_name', true);
	// 				// echo '<br>Last Order Date: ' . $last_order_date->format('Y-m-d');

	// 			} else {
	// 				return false;
	// 				// echo 'Customer within the last 3 months nothing to purchase.';
	// 			}
	// 		} else {
	// 			return false;
	// 			// echo 'Customer has no previous orders.';
	// 		}
	// 	} else {
	// 		return false;
	...
	<div class="coupon-success-blk mb-50">
		...
		<!-- <a href="javascript:void(0)" id="apply-coupon-btn" class="button mb tb apply-coupon mb-50 opn-coupon apply_coupon_check_btn">Apply Coupon</a> -->
	...
	<!-- apply cuopon end -->
	<input type="hidden" class="checkout_coupon_total" name="checkout_coupon_total" value="">
	...
	<div class="popup-box-blk" style="background-color: #242222e0;">
		<div class="popup-box text-center type1">
			...
			<div class="saving_amount px-4"> 
				<h3 class="mb-1" id="coupon_saving_amount">Save ₹250</h3>
			...
			<tr>
				...
				<td>
					...
					if (!empty($applied_coupons)) {
						...
						// echo '<span class="md discount_amount">' . wc_price($total_discount) . '</span>';
